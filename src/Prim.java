...
public class Prim
{
    ...
    private static String Array[]={"Psychology",
    	"History",
    	"Engineering",
    	"Sociology",
    	"Biology",
    ...
    public void printMST()
    {
        ...
        {
            System.out.println(Array[parent[vertex]] + "\t:\t" + Array[vertex] +"\t=\t"+ adjacencyMatrix[parent[vertex]][vertex]);
            total+=adjacencyMatrix[parent[vertex]][vertex];
        }
        System.out.println("totalmst"+total); 
    }
